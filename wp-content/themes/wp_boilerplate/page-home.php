    ...
    <div id="tooplate_main">
    	<div class="col_w960">
              <div class="col_allw300 frontpage_box">
                    <img src="http://localhost:8888/images/tooplate_bc_blue.png" alt="Image" />
                ...
                <div class="col_allw300 frontpage_box">
                    <img src="http://localhost:8888/images/tooplate_bc_green.png" alt="Image" />
                ...
                <div class="col_allw300 frontpage_box col_last">
                    <img src="http://localhost:8888/images/tooplate_bc_orange.png" alt="Image" />            
                  <h2>Social Media</h2>
            ...
            <div class="col_w960 col_last">
            	...
            	<div class="col_w450 lp_box float_l">
                    ...
                    <ul class="lp_frontpage">
                        <li><a href="#"><img width="200" height="100" src="http://localhost:8888/images/tooplate_image_01.jpg" alt="image" /></a></li>
                        <li><a href="#"><img width="200" height="100" src="http://localhost:8888/images/tooplate_image_02.jpg" alt="image" /></a></li>
                        <li><a href="#"><img width="200" height="100" src="http://localhost:8888/images/tooplate_image_03.jpg" alt="image" /></a></li>
                        <li><a href="#"><img width="200" height="100" src="http://localhost:8888/images/tooplate_image_04.jpg" alt="image" /></a></li>
                    </ul>    
                    <div class="cleaner"></div>
